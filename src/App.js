...
import ForcastMeteo from "./components/ForecastMeteo"
...
class App extends Component {
  ...
  getWeather = async e => {
    ...
    const api_call = await fetch(
      `http://api.openweathermap.org/data/2.5/weather?q=${city}${units}${lang}&APPID=${api_Key_Current}`
    );
    ...
    return (
      <div className="page-parent">
        <div className="page-child-top">
         ...
         <BrowserRouter>
              <div>
                <NavLink to="/ForcastMeteo" > ForcastMeteo </NavLink>

                <Switch>
                  <Route path="/ForcastMeteo" component={ForcastMeteo} />
                </Switch>
              </div>
            </BrowserRouter>
